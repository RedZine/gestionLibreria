...
public class MenuLibros {
    ...
    private void editar() {
        ...
        var existente = repositorio.findByIsbn(isbn);
        ...
        String nuevaCategoria = leerTexto("Nueva categoría (Enter mantiene: " + textoONulo(libro.getCategoria()) + "): ");
        ...
        if (!nuevaCategoria.isEmpty()) libro.setCategoria(nuevaCategoria);
    ...
    private void buscarPorIsbn() {
        String isbn = leerTextoObligatorio("\nISBN a buscar: ");
        var encontrado = repositorio.findByIsbn(isbn);
